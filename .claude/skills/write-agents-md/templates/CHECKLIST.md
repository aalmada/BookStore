...
- [ ] Complex workflows defer to skills (e.g., `/scaffold-write`)
...
### ✅ Skills Integration
- [ ] All skill references start with `/` (e.g., `/scaffold-write`)
- [ ] Skills are organized by category (Run, Scaffold, Verify, Debug, Deploy, Utility, Documentation)
- [ ] Skill aliases are documented (e.g., `/sw`→scaffold-write)
...
### ❌ Missing Skills
**Problem**: References `/scaffold-feature` but skill doesn't exist
**Solution**: Create skill with `/scaffold-skill` or remove reference
