...
2. **Create Skill File**
   ...
   - Create file `.claude/skills/{slug}/SKILL.md` using [templates/SKILL.md](templates/SKILL.md)
   - Replace all `{placeholders}` with your actual content

3. **Create Supporting Resources (If Needed)**
   - If the skill generates code or other artifacts, create `.claude/skills/{slug}/templates/`
...
4. **Register in AGENTS.md**
   ...
   - Include the `/skill-slug` command format with brief description
