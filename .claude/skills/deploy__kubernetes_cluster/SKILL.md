---
name: deploy__kubernetes_cluster
...
**Prerequisites**:
- `/ops__doctor_check` - Check kubectl, Docker, and Aspire CLI installation

**Alternatives**:
- `/deploy__azure_container_apps` - For simpler Azure Container Apps deployment

**Recovery**:
- `/deploy__rollback` - Rollback failed Kubernetes deployment

**Verification**:
- `/test__verify_feature` - Test the deployed application
