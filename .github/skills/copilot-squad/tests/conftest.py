"""Pytest configuration for copilot-squad eval tests.

The `copilot` SDK package is not required to be installed for the test suite
to run. All tests mock CopilotClient and session directly. We register a
lightweight stub module before any test module is imported.
"""
...
def _make_copilot_stub():
    """Return a stub module satisfying 'from copilot import CopilotClient, PermissionHandler'."""
