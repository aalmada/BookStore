...
public interface INotificationService
{
    ...
    /// </summary>
    ValueTask NotifyAsync(IDomainEventNotification notification, string tenantId, CancellationToken ct = default);

    /// <summary>
    /// Returns a stream of notifications for a client.
    /// </summary>
    IAsyncEnumerable<SseItem<IDomainEventNotification>> Subscribe(string tenantId, CancellationToken ct);
}
...
public class NotificationService : INotificationService
{
    ...
    public async IAsyncEnumerable<SseItem<IDomainEventNotification>> Subscribe(string tenantId, [System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken ct)
    {
